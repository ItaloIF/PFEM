...
# recorder
ops.recorder('Node','-file','out/rec_node2.txt','-time','-node',2,'-dof',2,'disp')
# https://openseespydoc.readthedocs.io/en/latest/src/recorder.html
...
# https://openseespydoc.readthedocs.io/en/latest/src/trigTs.html
